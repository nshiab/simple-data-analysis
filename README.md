...
> [JSR](https://jsr.io/@nshiab/simple-data-analysis). This is part of migrating
> the development of the library to Deno, rather than Node.js. You will still be
> able to install and use it with Node.js, Bun, and Deno. For more information,
> check the [GitHub repository](https://github.com/nshiab/simple-data-analysis).
