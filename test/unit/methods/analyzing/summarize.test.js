...
describe("summarize", function () {
    it("should summarize without keyCategory", function () {
        ...
        const summarizedData = summarize(data, undefined, undefined, undefined, undefined, false, 1);
    ...
    it("should summarize with keyCategory", function () {
        ...
        const summarizedData = summarize(data, "key2", "key1", undefined, undefined, false, 1);
        assert.deepEqual(summarizedData, [
            {
                value: "key2",
                key1: "Rubarbe",
