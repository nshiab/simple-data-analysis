...
describe("replaceValues", function () {
    it("should replace partial string values", function () {
        ...
        const replacedValues = replaceValues(data, "key1", "I am", "You are", "partialString");
    ...
    it("should replace entire string values", function () {
        const data = [{ key1: "I am potato", key2: "I am key2" }];
        const replacedValues = replaceValues(data, "key1", "I am potato", "You are potato", "entireString");
        assert.deepEqual(replacedValues, [
            { key1: "You are potato", key2: "I am key2" },
        ]);
    });
    ...
    it("should replace string values and skip errors", function () {
        ...
        const replacedValues = replaceValues(data, "key1", "I am", "You are", "partialString", true);
        assert.deepEqual(replacedValues, [
            { key1: "You are potato", key2: "I am key2" },
            { key1: 32, key2: "I am key2" },
        ]);
...
//# sourceMappingURL=replaceValues.test.js.map