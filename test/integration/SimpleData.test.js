...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const simpleDataClone = simpleData
            ...
            .modifyValues({
            key: "bonus",
            valueGenerator: (val) => typeof val === "number" ? val / 100 : NaN,
        })
            .showDuration()
            .modifyItems({
            key: "bonus",
            itemGenerator: (item) => typeof item.salary === "number" &&
            ...
            .filterItems({
            itemComparator: (item) => typeof item.hireDate === "string" &&
...
//# sourceMappingURL=SimpleData.test.js.map